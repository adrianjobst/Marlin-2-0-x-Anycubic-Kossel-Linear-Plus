...
#define CUSTOM_MACHINE_NAME "ClayBoy"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 260.00             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 1339.29,  1863.96 }  // default steps per unit for Kossel (GT2, 20 tooth)
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 24000.0,  708.78 }  // old; rounding??
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION       { 3000, 3000, 3000, 1500, 1500 }
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -15.6 } //Offset for Probe until it clicks. So no need for paper leveling anymore!
...
#define Z_MAX_POS 275 //DELTA_HEIGHT
